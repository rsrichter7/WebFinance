    ...
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 13.5, color: T.ink3, lineHeight: 1.6 }}>
          Voer je banksaldo in op een bepaalde datum. Transacties van vóór deze datum worden
          niet meegerekend bij het huidige saldo op het Dashboard.
        </div>
      </div>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <div style={{ position: 'relative' }}>
            <span style={{
              ...
              fontSize: 13, fontWeight: 600, color: T.ink3, pointerEvents: 'none',
            }}>€</span>
            <input
              type="number"
              step="0.01"
              value={bedrag}
              onChange={e => { setBedrag(e.target.value); setSaved(false) }}
              placeholder="0,00"
              style={{
                ...
                outline: 'none', boxSizing: 'border-box', ...TAB,
              }}
            />
          </div>
        </div>
