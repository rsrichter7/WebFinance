...
import { T, TAB, fmtShort } from '../../tokens'
import { ICONS } from '../ui/Icons'

export default function CalendarDayCell({
  day, dayData, isToday, isSelected, viewFilter, paidIds, onClick, isFuture,
}) {
  ...
  // Vinkje als een verwachte vaste last betaald is deze maand
    ...
    >
      ...
      {hasExpected && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 3, marginBottom: 3 }}>
          ...
          <span style={{ fontSize: 10.5, color: T.blueText, fontWeight: 500, ...TAB }}>
            {fmtShort(totalExpected)}
          </span>
        </div>
      )}
      ...
      {hasIncome && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 3, marginBottom: 3 }}>
          ...
          <span style={{ fontSize: 10.5, color: T.greenText, fontWeight: 500, ...TAB }}>
      ...
      {hasActual && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
          ...
          <span style={{ fontSize: 10.5, color: T.ink2, fontWeight: 500, ...TAB }}>
