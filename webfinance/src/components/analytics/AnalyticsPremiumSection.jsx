...
function GhostWidget({ title, type }) {
  return (
    <div style={{
      ...
      borderRadius: 12, padding: 18, opacity: 0.45,
    }}>
      ...
      {type === 'donut' && (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 90 }}>
          <div style={{
            ...
            border: `8px solid ${T.rule}`,
            borderTopColor: T.blue, borderRightColor: T.violet,
          }} />
        </div>
      )}
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
        ...
        <span style={{
          ...
          borderRadius: 4, background: T.amberSoft, color: T.amber, letterSpacing: 0.3,
        }}>PREMIUM</span>
      </div>
