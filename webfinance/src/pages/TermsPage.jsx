...
const SECTIES = [
  ...
  { titel: '5. Bankkoppeling via Enable Banking', tekst: 'Webfinance kan, met jouw uitdrukkelijke toestemming, een koppeling maken met je bankrekening via de externe dienst Enable Banking, om transacties automatisch op te halen. [Placeholder: geldigheidsduur van de koppeling, wat Enable Banking wel/niet mag, hoe je de koppeling weer kunt verbreken, aansprakelijkheid bij storingen aan de kant van de bank of Enable Banking.]' },
  { titel: '6. Aansprakelijkheid', tekst: '[Placeholder: beperking van aansprakelijkheid voor onjuiste berekeningen, dataverlies, downtime of gevolgen van beslissingen die gebruikers baseren op de app. Uitsluitingen en eventuele maximumbedragen moeten juridisch bepaald worden.]' },
  { titel: '7. Opzegging en gegevens', tekst: 'Je kunt je account op elk moment verwijderen via Instellingen. [Placeholder: wat er precies gebeurt met je gegevens bij opzegging, bewaartermijnen, gevolgen voor gedeelde huishoudens.] Zie ook ons <link>privacybeleid</link> voor meer informatie over gegevensverwerking.' },
  { titel: '8. Wijzigingen van deze voorwaarden', tekst: '[Placeholder: hoe en wanneer wijzigingen worden aangekondigd, en vanaf welk moment gewijzigde voorwaarden gelden voor bestaande gebruikers.]' },
  { titel: '9. Toepasselijk recht', tekst: '[Placeholder: welk recht van toepassing is en welke rechter bevoegd is bij geschillen.]' },
]
